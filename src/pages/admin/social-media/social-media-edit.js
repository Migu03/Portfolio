...
import $ from "jquery";
import { getSm, updateSm } from "@/api/social-media";

const smEditAdmin = ({id}) => {
        ...
        <div class="container pt-5">
          <form action="" id="formAddCategory">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="sm-name" id="sm-name" value="${sm.name}"/>
              </div>
              <div class="form-group">
                  <label for="sm-link" class="form-label text-sm font-weight-bolder">Link</label>
                  <input type="text" class="form-control" name="sm-link" id="sm-link" value="${sm.link}"/>
              </div>
              <div class="form-group">
                  <label for="sm-tag" class="form-label text-sm font-weight-bolder">Tag</label>
                  <input type="text" class="form-control" name="sm-tag" id="sm-tag" value="${sm.tag}"/>
              </div>
